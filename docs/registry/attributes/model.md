...
| <a id="mcp-resource-uri" href="#mcp-resource-uri">`mcp.resource.uri`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The value of the resource uri. [24] | `postgres://database/customers/schema`; `file:///home/user/documents/report.pdf` |
...
**[24] `mcp.resource.uri`:** This is a URI of the resource provided in the following requests or notifications: `resources/read`, `resources/subscribe`, `resources/unsubscribe`, or `notifications/resources/updated`.
...
## Model Gen AI Deprecated Registry Deprecated Attributes
